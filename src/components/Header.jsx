...
const Header = () => {
    ...
    return (
        <header className="fixed top-0 left-0 w-full px-5 lg:px-20 py-5 lg:py-4 flex justify-end lg:justify-center items-center bg-black shadow-md z-20 border-white">
