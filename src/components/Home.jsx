...
const Home = () => {
    return (
        <section className="min-h-screen flex justify-center items-center bg-black text-white px-36">
            <div className="flex flex-col md:flex-row items-center gap-14 lg:gap-20">
                <div className="rounded-full border-2 lg:border-[3px] border-Purple1 overflow-hidden w-[200px] lg:min-w-64 mt-[90px] lg:mt-0">
                ...
                <div className="text-center md:text-left">
                    ...
                    <h3 className="text-2xl lg:text-4xl font-bold my-2">I'm a <span className='lg:hidden'><br /></span><TypingEffect className="text-Purple1" text={['Front End Developer', 'Problem Solver', 'Programmer']} speed={100} eraseSpeed={100} typingDelay={100} eraseDelay={1500} cursorRenderer={cursor => <h1>{cursor}</h1>} /></h3>
                    <p className="text-base lg:text-lg mt-8">As a final-year B.Tech CSE student with a focus on AI/ML and front-end development, I'm really into creating smart systems and user-friendly interfaces. I enjoy working on projects that combine technology and creativity, whether it's building machine learning models or developing interactive web applications. My aim is to improve user experiences and explore new ideas in tech.</p>
